<form class="md:w-1/2 space-y-5" wire:submit.prevent='editarVacante'>
    <div>
        ...
        <x-text-input id="titulo" wire:model="titulo" class="block mt-1 w-full" type="text" :value="old('titulo')"
    ...
    <div>
        <textarea wire:model="descripcion" placeholder="Descipción general del puesto, experiencia"
